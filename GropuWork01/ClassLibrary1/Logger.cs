...
namespace ClassLibrary1
{
    ...
    public sealed class Logger
    {
        ...
        /// 日志根目录
        /// </summary>
        private static string log_root_directory = ConfigurationManager.AppSettings["LOG_Directory"];
        ...
        private static string GetLogFullPath
        {
            get
            {
                return string.Concat(log_root_directory, '\\', string.Concat(log_subdir, @"\log", CurrentLogFileDate.ToString("M"), ".txt"));
            }
        }
